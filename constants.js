...
export const ENEMY_PROJECTILE_SPEED = 20; // Units per second
export const CHASER_SPEED = 6; // Original Enemy Speed
export const CRUISER_SPEED = 9; // New Slower Enemy Speed (Bomber)
export const ENEMY_SPAWN_TIME = 1.5; // seconds per spawn
export const POWERUP_SPAWN_TIME = 8; // seconds per spawn
export const BURST_COOLDOWN_SECONDS = 5;
export const TRIPLE_SHOT_DURATION_SECONDS = 5;
export const INITIAL_SHIELD_HP = 5;
export const ENEMY_SPAWN_X = 100; // X-coordinate where enemies spawn (Right side)
export const ENEMY_DESPAWN_X = -100; // X-coordinate where enemies go off screen (Left side)
